...
namespace ML.Core.Data
{
    ...
    public sealed class Range
    {
        ...
        {
            index.Should().BeGreaterThan(0, "Must be non-negative");
            Min = index;
            Max = index;
        }
        ...
        {
            min.Should().BePositive();
            max.Should().BeGreaterThan(min, "If specified, must be greater than or equal to " + nameof(min));
